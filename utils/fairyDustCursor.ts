...
export function fairyDustCursor(options?: FairyDustOptions) {
    ...
    function addParticle(x: number, y: number, canv: HTMLCanvasElement) {
        particles.push(new Particle(x, y, canv));
    }
